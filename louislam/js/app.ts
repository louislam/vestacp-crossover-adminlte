...
class LouisAdminLTE {
    ...
    private initUI() {
        ...
        $.get("/louislam/view/template.php",  (html) => {
            ...
            modal.find(".skin-block").each((i, elem) => {
                var skinName = $(elem).data("skin");
                $(elem).css("background-image", "url(/louislam/img/"+ skinName +".png)").click(() => {
