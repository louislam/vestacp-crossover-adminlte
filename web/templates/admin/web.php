	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<div class="row">
				...
				<div class="col-md-7">
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<div id="advtable" style="<?php if (empty($v_adv)) echo 'display:none';?> ;">
								<div class="form-group">
								...
								<div class="form-group" style="display:<?php if ($v_proxy == 'off') { echo 'none';} else {echo 'block';}?>;" id="proxytable" >
									<label><?php print __('Proxy Extentions');?></label>
									<textarea  rows="5" class="vst-textinput form-control" name="v_proxy_ext"><?php if (!empty($v_proxy_ext)) { echo $v_proxy_ext;} else { echo 'jpeg, jpg, png, gif, bmp, ico, svg, tif, tiff, css, js, htm, html, ttf, otf, webp, woff, txt, csv, rtf, doc, docx, xls, xlsx, ppt, pptx, odf, odp, ods, odt, pdf, psd, ai, eot, eps, ps, zip, tar, tgz, gz, rar, bz2, 7z, aac, m4a, mp3, mp4, ogg, wav, wma, 3gp, avi, flv, m4v, mkv, mov, mp4, mpeg, mpg, wmv, exe, iso, dmg, swf'; }  ?></textarea>
								...
								<div class="form-group">
									<label><input type="checkbox"  class="" name="v_ftp" <?php if (!empty($v_ftp)) echo "checked=yes" ?> onclick="App.Actions.WEB.toggle_additional_ftp_accounts(this)"> <?php print __('Additional FTP Account');?></label>
								</div>
								...
								<a class="additional-control" href="javascript:App.Actions.WEB.add_ftp_user_form()"><?php print __('Add one more FTP Account');?></a>
							</div>
				...
				<div class="col-md-5" style="display:<?php if (empty($v_ssl)) { echo 'none';} else {echo 'block';}?>;" id="ssltable">
					<div class="box box-primary">
						<div class="box-header">
...
<div id="templates" style="display:none">
	<table class="ftptable ftptable-nrm" name="v_add_domain_ftp">
		...
		<tr>
			<td class="step-left">
				<input type="text"  class="vst-input v-ftp-user" name="v_ftp_user[%INDEX%][v_ftp_user]" value="">
